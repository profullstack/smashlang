...
1. Copy this `__package__template` directory to create your new package:

   ```bash
   cp -r smashlang_packages/__package__template smashlang_packages/[category]/[your_package_name]
   ```

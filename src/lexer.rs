    ...
    while let Some(&ch) = chars.peek() {
        match ch {
            ...
            '`' => {
                    ...
                    if ch == '`' {
                        ...
                        if let Some(&next_ch) = chars.peek() {
                            if next_ch == '{' {
                                ...
                                // For now, we'll just include it as part of the template string
                                template.push('$');
                                template.push('{');
                                chars.next(); // consume the {
                ...
                tokens.push(Token::TemplateString(template));
            }
            '<' => {
                chars.next(); // consume the '<'
